			...
			<div class="col-lg-12">
				<div class="panel panel-default">
							<div class="panel-heading">
								<strong><?php echo $firstname . "'s Assigned Tickets</h1>"; ?></strong>
							</div>
							<div class="panel-body">

		<?php
	  $allopen = $db->query("SELECT tID, id, date, userid, category, department, urgency, assigned, id, status FROM ticket WHERE assigned = '$userid' ORDER BY date ASC");
	  if(count($allopen) > 0 ) {
	  echo "<div class='row'>
					<div class='col-lg-12'>
